#!/usr/bin/env python3
"""
Script to create AI agents in the database.
"""
...
def create_ai_agents():
    ...
    ai_agents = [
        ...
        },
        {
            ...
            "personality_description": "Deep analytical and predictive intelligence. Analyst excels at complex data analysis, pattern recognition, and strategic insights.",
            "is_global": True,
            "is_active": True
        }
    ]
