...
# These will be overridden in production settings
if not DEBUG:
    ...
    # Development security settings (less strict for local development)
    ...
    # Session and CSRF Security for development
